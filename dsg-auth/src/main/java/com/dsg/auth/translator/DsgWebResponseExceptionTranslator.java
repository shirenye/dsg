package com.dsg.auth.translator;
...
public class DsgWebResponseExceptionTranslator implements WebResponseExceptionTranslator {

    @Override
    public ResponseEntity<?> translate(Exception e) {
        ResponseEntity.BodyBuilder status = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR);
        DsgResponse response = new DsgResponse();
        String message = "认证失败";
        log.error(message, e);
