 ...
 * @author MrBird
 */
public class DsgUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public DsgUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
